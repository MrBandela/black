...
router.post('/send_login_otp',(req, res, next) => {
  req = adaptRequest(req);
  authController.sendOtpForLogin(req).then((result) => {
    sendResponse(res, result);
  })
    .catch((e) => {
      sendResponse(res, e);
...
router.post('/login_with_otp',(req,res,next)=>{
  req = adaptRequest(req);
  authController.loginWithOTP(req).then((result) => {
    sendResponse(res, result);
  })
    .catch((e) => {
      sendResponse(res, e);
